...
export default function Servisesthree() {
  return (
    <section className="bg-gradient-to-br from-blue-900 via-slate-800 to-teal-900 text-white py-20 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="opacity-0 animate-fade-in animation-delay-200">
          <Image
            src="/services/Quality Assurance.jpg" // Replace with your actual image path
