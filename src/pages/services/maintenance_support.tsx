       ...
       />
           ...
           >
             ...
             <p className="flex text-center items-start text-base sm:text-lg md:text-xl text-gray-800 dark:text-gray-200">
               ...
               It is not about availability of a single unit or module but making sure that all of IT infrastructure and software runs smoothly and reliably meeting the SLAs.    </p>
           </motion.div>
         </section>
       <SoftwareMaintenance/>
    <DatabaseManagement/>
