      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav className="hidden md:flex">
          <ul className="flex space-x-8 text-gray-700 font-medium">
            ...
            <li>
              <Link href="/about/whychoosebeavertek" className="hover:text-green-700 transition">
                About
              </Link>
            </li>
            <li>
              <Link
                href="/customers/customerherosection"
            ...
            <li>
              <Link href="/services/servicesherosection" className="hover:text-green-700 transition">
                Services
              </Link>
            </li>
            <li>
              <Link href="/products/productherosection" className="hover:text-green-700 transition">
                Products
              </Link>
            </li>
            <li>
              <Link href="/contact/contactherosection" className="hover:text-green-700 transition">
                Contact
              </Link>
            </li>
          </ul>
